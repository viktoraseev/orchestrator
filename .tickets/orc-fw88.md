...
Реализованы публичный API и CLI agent show с ранней проверкой AgentId, полной config validation, text/JSON renderer и source-tagged acceptance; ./scripts/test.sh и ./scripts/build.sh проходят.
